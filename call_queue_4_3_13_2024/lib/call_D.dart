...
class _QueueScreenState extends State<QueueScreen> {
  ...
  void soundvolumn(String number) async {
    ...
    await player.play(AssetSource('sounds4/Bell.m4a'));
    await Future.delayed(Duration(milliseconds: 1000));
    await player.play(AssetSource('sounds4/number.m4a'));
    await Future.delayed(Duration(milliseconds: 1000));
    int consecutiveZeros = 0;
    for (int i = 0; i < numberString.length; i++) {
      String digit = numberString[i];
      await player.play(AssetSource('sounds4/$digit.m4a'));
