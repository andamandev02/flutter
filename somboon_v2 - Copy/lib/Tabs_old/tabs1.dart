...
import 'package:somboon_v2/end_queue.dart';
import 'TabData.dart';
...
class _Tab1State extends State<Tab1> {
  ...
  // bool _isReasonLoading = false; // ตัวแปรสถานะการโหลด
  ...
  //                             : () async {
  //                                 setState(() {
  //                                   _isReasonLoading = true; // เริ่มการโหลด
  //                                 });
  ...
  //                                 );
  //                                 setState(() {
  //                                   _isReasonLoading = false; // จบการโหลด
  //                                 });
  //                               },
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                Flexible(
                  child: Numpad(
                    onSubmit: (value, name, phone) async {
                      try {
                        SnackBarHelper.showErrorSnackBar(
                            context, "กำลังพิมพ์บัตรคิว", "กรุณารอสักครู่ ...");
