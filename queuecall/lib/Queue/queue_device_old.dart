...
//                                                     setState(() {
//                                                       isChecked =
//                                                           newValue; // ปรับค่า isChecked ตามสถานะของ Checkbox
//                                                     });
//                                                     // เรียกใช้งานเมื่อ Checkbox ถูกเปลี่ยนแปลง
//                                                     if (isChecked) {
...
//                                                         setState(() {});
//                                                       }
//                                                       if (controller.address1 !=
//                                                           null) {
//                                                         await controller
//                                                             .clientModel1!
//                                                             .connect(); // เชื่อมต่อสำหรับ controller.address1
//                                                         final info =
//                                                             await deviceInfo1
//                                                                 .androidInfo;
//                                                         setState(() {});
...
//                                                           .isConnected) {
//                                                         debugPrint(
//                                                             "Disconnecting from Display 2....");
//                                                         controller.clientModel1!
//                                                             .disconnect(
//                                                                 androidDeviceInfo1); // ตัดการเชื่อมต่อสำหรับ controller.address1
//                                                       } else {
//                                                         controller.clientModel1!
//                                                             .connect(); // เชื่อมต่อสำหรับ controller.address1
//                                                       }
...
//                                         ),
//                                         if (controller.address1 !=
//                                             null) // เพิ่มการตรวจสอบสำหรับ controller.address1
//                                           Row(
//                                             children: [
//                                               Transform.scale(
//                                                 scale:
...
//                                                       setState(() {
//                                                         isChecked1 =
//                                                             newValue; // ปรับค่า isChecked1 ตามสถานะของ Checkbox
//                                                       });
...
//                                                               .clientModel1!
//                                                               .disconnect(
//                                                                   androidDeviceInfo); // ตัดการเชื่อมต่อสำหรับ controller.address1
//                                                         } else {
//                                                           controller
//                                                               .clientModel1!
//                                                               .connect(); // เชื่อมต่อสำหรับ controller.address1
...
//                                               ),
//                                               Text(
//                                                 "จอแสดงผล Display 2 : ${controller.address1!.ip} PORT : ${controller.port1}",
//                                                 style: const TextStyle(
//                                                   fontSize: 10,
//                                                   fontWeight: FontWeight.bold,
//                                                 ),
...
//                                               ),
//                                               Text(
//                                                 "จอแสดงผล Display 3 : ${controller.address2!.ip} PORT : ${controller.port2}", // แสดงข้อมูลสำหรับ controller.address1
//                                                 // "จอแสดงผล Display 3", // แสดงข้อมูลสำหรับ controller.address1
//                                                 style: const TextStyle(
//                                                     fontSize: 10,
//                                                     fontWeight:
//                                                         FontWeight.bold),
